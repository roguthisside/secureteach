  ...
  useEffect(() => {
    ...
    const loadCourses = () => {
      ...
      try {
        ...
        if (isTeacher) {
          userCourses = courseService.getCoursesByInstructor(user?.id || '');
        } else {
          userCourses = courseService.getEnrolledCourses(user?.id || '');
        }
    ...
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
        ...
        <Card className="transition-all hover:shadow-md">
          ...
          <CardFooter>
            <Button variant="ghost" size="sm" className="w-full" asChild>
              <Link to="/students" className="flex items-center justify-center gap-2">
                View Students
                <ArrowUpRight className="h-4 w-4" />
              </Link>
            </Button>
      ...
      <div>
        ...
        <Tabs defaultValue="all" className="w-full">
          ...
          <TabsContent value="published">
            ...
            {/* For brevity, implementation not shown */}
          </TabsContent>
    ...
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
        <Card className="transition-all hover:shadow-md">
          ...
          <CardFooter>
            <Button variant="ghost" size="sm" className="w-full" asChild>
              <Link to="/my-learning" className="flex items-center justify-center gap-2">
                View Courses
                <ArrowUpRight className="h-4 w-4" />
              </Link>
            </Button>
        ...
        <Card className="transition-all hover:shadow-md">
          ...
          <CardContent>
            ...
            <p className="text-muted-foreground text-sm">Finished courses</p>
          </CardContent>
          <CardFooter>
            <Button variant="ghost" size="sm" className="w-full" asChild>
      ...
      <div className="mb-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-4">
          ...
          <Button variant="outline" asChild className="h-auto p-6 flex flex-col items-center gap-3 text-lg font-medium rounded-xl">
            <Link to="/my-learning">
              <GraduationCap className="h-10 w-10 mb-1" />
              My Learning
            </Link>
          </Button>
      ...
      {/* Enrolled Courses */}
      <div>
        <h2 className="text-xl font-semibold mb-6">Your Learning</h2>
